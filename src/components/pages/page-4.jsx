...
<head>
  ...
  <title>Модуль 5 задание 2</title>
  ...
  <div class="wrap">
    <header class="header">
      ...
      <div class="header__box">
        <h1 class="header__title">
          Галерея фотографий наших проектов
        </h1>
        <p class="header__text">
          На этой странице подобраны фотографии наших лучших <br>проектов. Ваш может быть таким же прекрасным.
        </p>
        <a href="#" class="header__link">
          <span class="visually-hidden">Смотреть все</span>
    ...
    <main class="content">
      <section class="content__block">
        <div class="content__text-wrap">
         <p class="content__text">
          Green house — архитектурно-строительная компания с комплексным подходом к проектированию и реализации современных загородных домов премиум класса. В нем описан подробный план действий для строителей: какие технологии и материалы необходимо применять. В нашем портфолио более 200 частных вилл, а также десятки уникальных проектов коммерческой недвижимости.
         </p>
        </div>

        <img class="content__image" src="about-1.jpg" alt="дома green house">
      </section>

      <section class="content__block content__block--inverted">
       <div class="content__text-wrap">
        <p class="content__text">
         Green house — архитектурно-строительная компания с комплексным подходом к проектированию и реализации современных загородных домов премиум класса. В нем описан подробный план действий для строителей: какие технологии и материалы необходимо применять. В нашем портфолио более 200 частных вилл, а также десятки уникальных проектов коммерческой недвижимости.
        </p>
       ...
       <img class="content__image" src="about-2.jpg" alt="дома green house">
     </section>
     ...
     <section class="content__block">
       ...
       <img class="content__image" src="about-3.jpg" alt="дома green house">
     </section>
    </main>
