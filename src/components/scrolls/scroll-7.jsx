...
const Scroll7 = () => {
  ...
  return (
    <div className="scroll-7">
      <main>
        <button type="button" className="btn btn--scroll-to">
          scroll / scrollTo
        </button>
        <button type="button" className="btn btn--scroll-by">
          scrollBy
        </button>
        ...
        <p>
          ...
          ratione voluptate maxime impedit vero blanditiis ut non illo repellat
          aut officia?
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Et
